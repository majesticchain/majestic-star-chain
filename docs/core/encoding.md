...
Learn about the encoding formats used on Majestic StarChain. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Majestic StarChain does not
...
allows for quick reconstruction of encoded data. Majestic StarChain uses RLP to encode/decode Ethereum
...
Learn how [pending state](./pending_state.md) is handled on Majestic StarChain. {hide}
