...
Learn how Majestic StarChain handles pending state queries. {synopsis}

## Pre-requisite Readings

- [Tendermint Mempool](https://docs.tendermint.com/master/tendermint-core/mempool.htm) {prereq}

## Majestic StarChain vs Ethereum
...
Majestic StarChain is designed quite differently on this front as there is no concept of a "pending state".
Majestic StarChain uses [Tendermint Core](https://docs.tendermint.com/) BFT consensus which provides instant
...
first-in-first-out (FIFO) fashion. Transactions on Majestic StarChain cannot be ordered or cherry-picked out from the Tendermint node mempool.

## Pending State Queries

Majestic StarChain will make queries which will account for any unconfirmed transactions present in a node's
...
Learn how to deploy a Solidity smart contract on Majestic StarChain using [Truffle](./../guides/truffle.md) {hide}
