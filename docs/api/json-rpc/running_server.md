...
```bash
mjtd start --json-rpc.api eth,txpool,personal,net,debug,web3,miner
```
...
```bash
# set gas cap to 85M
mjtd start --json-rpc.gas-cap 85000000000

# set gas cap to infinite (=0)
mjtd start --json-rpc.gas-cap 0
```
