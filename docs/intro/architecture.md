...
Learn how Majestic StarChain's architecture leverages the Cosmos SDK Proof-of-Stake functionality, EVM compatibility and fast-finality from Tendermint Core's BFT consensus. {synopsis}

## Cosmos SDK

Majestic StarChain enables the full compatibility and modularity of the [Cosmos SDK](https://docs.cosmos.network/).
...
engines of other blockchains. Majestic StarChain is such an example of an ABCI application
...
Majestic StarChain enables EVM compatibility by implementing various components that together support all the EVM state transitions while ensuring the same developer experience as Ethereum:
...
Check the available Majestic StarChain [resources](./resources.md) {hide}
