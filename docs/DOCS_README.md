...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/majesticchain/majestic-star-chain/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for Majestic StarChain is hosted at [evmos.dev](https://evmos.dev/)

built from the files in this (`/docs`) directory for
[master](https://github.com/majesticchain/majestic-star-chain/tree/main/docs).
