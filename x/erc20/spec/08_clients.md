...
Find below a list of  `mjtd` commands added with the `x/erc20` module. You can obtain the full list by using the `mjtd -h` command. A CLI command can look like this:

```bash
mjtd query erc20 params
```
