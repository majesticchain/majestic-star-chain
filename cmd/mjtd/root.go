...
// NewRootCmd creates a new root command for mjtd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := servercfg.AppConfig("amjt")
...
func (a appCreator) appExport(
	...
	if height != -1 {
		mjtApp = app.NewMjt(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := mjtApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		mjtApp = app.NewMjt(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return mjtApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
